...
gamesCard.innerHTML = `${gameCount.toLocaleString('en-US')}`
...
const unFundedGamesCount = GAMES_JSON.reduce( (totalUnfund, game) => {
    return (game.pledged < game.goal) ? (totalUnfund + 1) : totalUnfund;
}, 0);
// console.log(unFundedGamesCount)

// create a string that explains the number of unfunded games using the ternary operator
const displayStr = 
    `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${gameCount} game${gameCount === 1 ? '' : 's'}. 
...
const paragraphDisplayStr = document.createElement("p");
paragraphDisplayStr.innerHTML = displayStr; 
descriptionContainer.appendChild(paragraphDisplayStr);
