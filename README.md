...
* [X] Navigation Bar to "Stats" and "Our Games" section
...
A challenge I encountered include implementing the Javascript logic with the correct syntax, eg. for loop. Whenever there is a syntax error, the application stops displaying information as expected. Another one was understanding the concept for reduce as an accumulator and not a compressing/mapping function.
